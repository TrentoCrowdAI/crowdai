...
const run = async () => {
  ...
  try {
    ...
    let simulatedVotes = [
      [[0, 1], [1, 1], [2, 1]], // item 1, filter 1   [worker_id, vote] 1: in, 0: out
      [[0, 1], [1, 1], [2, 1]], // item 1, filter 2
      [[0, 1], [1, 0], [2, 0]], // item 1, filter 3
      [[0, 0], [1, 0], [2, 0]], // item 2, filter 1
      [[0, 1], [1, 1], [2, 1]], // item 2, filter 2
      [[0, 0], [1, 1], [2, 0]], // item 2, filter 3
      [[0, 0], [1, 1], [2, 1]], // ...
      [[0, 1], [1, 0], [2, 1]],
      [[0, 1], [1, 0], [2, 1]],
      [[0, 1], [1, 1], [2, 1]],
