...
class StackedBarChart extends React.Component {
  ...
  buildGraph() {
    ...
    var z = this.props.z
		...
		//filter data basing on both paramters
    ...
    var g = svg.append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
		...
		//color scale for 3 categories of answers
    var color = d3.scaleOrdinal()
    		.range(['orange','lightgreen','#2185d0'])
    ...
    color.domain(y)
		...
		//build percentage bars for each element on the y axis
    data.forEach( function(row) {
		...
		//scale axis basing on resulting bars
