...
--   }
--   shortestRun: {} // property set only if the task assignment strategy is Shortest Run
--   estimationToken: <string> // value generated by the estimation-api
--   estimations: [] // value generated by the estimations-api
-- }
CREATE TABLE job (
  id bigserial NOT NULL,
